...
<body>
	...
	<div class="row h-100 mt-5 justify-content-center align-items-center">
		<div class="col-md-5 mt-3 pt-2 pb-5 align-self-center border bg-light">
			<h1 class="mx-auto w-25" >Nieuwe collega registreren</h1>
			<?php 
    		...
    		<form method="POST" action="./ad.php">
    			<label class="color">voornaam:</label><input type="text" name="voornaam">
    			<label class="color">achternaam:</label><input type="text" name="achternaam">
                <label class="color">email:</label><input type="text" name="email">
    			<label class="color">adres:</label><input type="text" name="adres">
    			<label class="color">postcode:</label><input type="text" name="postcode" maxlength="6">
    			<label class="color">woonplaats:</label><input type="text" name="woonplaats">
    			<label class="color">geboortedatum:</label><input type="date" name="geboortedatum">
    			<label class="color">gebruikersnaam:</label><input type="text" name="gebruikersnaam">
